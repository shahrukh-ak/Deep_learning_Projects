...
x_train = genfromtxt('iris.csv', delimiter=',', usecols=(i for i in range(0,3)) , skip_header=1) 
y_train = genfromtxt('iris.csv', delimiter=',', usecols=(4), skip_header=1)

x_test = genfromtxt('iris.csv', delimiter=',', usecols=(i for i in range(0,3)) ,skip_header=1 )
y_test = genfromtxt('iris.csv', delimiter=',', usecols=(4), skip_header=1)
